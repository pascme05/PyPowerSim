...
# General
# ------------------------------------------
setup['Exp']['Name'] = "journalCouplingSecVIB"                                                                           # name of the simulation (str)
...
# Operating Mode
# ------------------------------------------
setup['Exp']['output'] = 'I'                                                                                             # (Mi): modulation index controlled, (V): voltage is controlled, (I): current is controlled, (P): active power is controlled, (Q): reactive power is controlled
...
# ------------------------------------------
setup['Exp']['conf'] = "journalCouplingSecVIB"
