...
# Experiment
# ------------------------------------------
setupExp['Name'] = "calcJournal_Trans"                                                                                  # name of the simulation (str)
...
# Numerical
# ------------------------------------------
setupExp['fsim'] = 1e5                                                                                                  # simulation frequency (Hz)
...
# ------------------------------------------
# Transient
setupData['trans']['tmax'] = 50/50                                                                                      # maximum time for transient analysis (sec)
...
setupData['stat']['Io'] = 75                                                                                            # output RMS phase current (Io) in (A) for current control
...
# Hardware
# ------------------------------------------
setupTopo['SwiName'] = "2MBI300XBE120"                                                                                  # filename of the parameter set
...
# ------------------------------------------
# Parameters
setupTopo['R'] = 2.5                                                                                                    # resistance in (Ohm)
setupTopo['L'] = 2.5e-3                                                                                                 # inductance in (H)
...
setupPara['Ther']['Coupling'] = 2                                                                                       # 0) no thermal coupling between diode and transistor, 1) thermal coupling between diode and transistor, 2) thermal coupling via whole converter
