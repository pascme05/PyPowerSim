...
# Experiment
# ------------------------------------------
setupExp['Name'] = "compareMat"                                                                                         # name of the simulation (str)
...
# ------------------------------------------
# Parameters
setupTopo['R'] = 1                                                                                                    # resistance in (Ohm)
...
# Switches (Swi)
# ------------------------------------------
setupPara['Elec']['SwiMdl'] = "pwl"                                                                                     # modelling of the switch (con): constant parameters, (pwl): piecewise linear, (tab): tabulated parameters
