...
# General
# ------------------------------------------
setup['Exp']['Name'] = "compareMat"                                                                                      # name of the simulation (str)
...
# ------------------------------------------
setup['Exp']['conf'] = "compareMat"

# ------------------------------------------
# Devices
# ------------------------------------------
# Inverter Topologies (B6, B4, B2)
setup['Exp']['Swi'] = "Matlab_IGBT"                                                                                      # filename of the parameter set for the switching devices
