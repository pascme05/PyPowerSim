...
# Experiment
# ------------------------------------------
setupExp['Name'] = "compareFuji"                                                                                        # name of the simulation (str)
...
# Operating Mode
# ------------------------------------------
setupExp['output'] = 'I'                                                                                                # (Mi): modulation index controlled, (V): voltage is controlled, (I): current is controlled, (P): active power is controlled, (Q): reactive power is controlled
