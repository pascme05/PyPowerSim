...
def genSwSeq(setupPara):
    ...
    if setupPara['PWM']['seq'] == "1012":
        seq = [[1, 0, 1, 2, 2, 1, 0, 1], [2, 7, 2, 3, 3, 2, 7, 2], [3, 0, 3, 4, 4, 3, 0, 3], [4, 7, 4, 5, 5, 4, 7, 4],
               [5, 0, 5, 6, 6, 5, 0, 5], [6, 7, 6, 1, 1, 6, 7, 6]]

    # ==============================================================================
    # 7212
    # ==============================================================================
    if setupPara['PWM']['seq'] == "2721":
        seq = [[2, 7, 2, 1, 1, 2, 7, 2], [3, 0, 3, 2, 2, 3, 0, 3], [4, 7, 4, 3, 3, 4, 7, 4], [5, 0, 5, 4, 4, 5, 0, 5],
               [6, 7, 6, 5, 5, 6, 7, 6], [1, 0, 1, 6, 6, 1, 0, 1]]
