...
def calcTransB2(mdl, para, setupTopo, setupData, setupPara, setupExp):
    ...
    for i in trange(iterNel, desc='Elec-Period'):
        ...
        for ii in trange(iterNpwm, desc='PWM-Period', leave=False):
            ...
            # Losses
            timeLoss['sw']['S1'] = calcLossSwi(s[start:ende]*(+1), timeElec['sw']['S1']['i_T'], timeElec['sw']['S1']['i_D'], timeElec['sw']['S1']['v_T'], timeElec['sw']['S1']['v_D'], Tj[0], para, setupPara, setupTopo)
            timeLoss['sw']['S2'] = calcLossSwi(s[start:ende]*(-1), timeElec['sw']['S2']['i_T'], timeElec['sw']['S2']['i_D'], timeElec['sw']['S2']['v_T'], timeElec['sw']['S2']['v_D'], Tj[1], para, setupPara, setupTopo)
