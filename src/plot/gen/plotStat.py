...
def plotStat(time, freq, setup):
    ...
    for i in range(0, 2):
        plt.subplot(4, 2, 1 + i)
        plt.plot(t_plot[::down2], timeElec['sw'][id1[i]]['i_T'][::down2], t_plot[::down2], timeElec['sw'][id1[i]]['i_D'][::down2])
        plt.ylabel("$i(t)$ (A)")
        ...
        # Voltage
        plt.subplot(4, 2, 3 + i)
        plt.plot(t_plot[::down2], timeElec['sw'][id1[i]]['v_T'][::down2], t_plot[::down2], timeElec['sw'][id1[i]]['v_D'][::down2])
        plt.ylabel("$v(t)$ (V)")
        ...
        # Losses
        plt.subplot(4, 2, 5 + i)
        plt.plot(t_plot[::down2], timeLoss['sw'][id1[i]]['p_T_c'][::down2], t_plot[::down2], timeLoss['sw'][id1[i]]['p_D_c'][::down2])
        plt.ylabel("$p(t)$ (W)")
        ...
        # Losses
        plt.subplot(4, 2, 7 + i)
        plt.plot(t_plot[::down2], timeLoss['sw'][id1[i]]['p_T_s'][::down2], t_plot[::down2], timeLoss['sw'][id1[i]]['p_D_s'][::down2])
        plt.ylabel("$p(t)$ (W)")
    ...
    plt.figure()
    plt.subplot(2, 2, 1)
    plt.plot(t_plot[::down2], timeLoss['sw']['S1']['p_T'][::down2], t_plot[::down2], timeLoss['sw']['S1']['p_D'][::down2])
    plt.ylabel("$p(t)$ (W)")
    ...
    # Temperature
    plt.subplot(2, 2, 3)
    plt.plot(t_plot[::down2], timeTher['sw']['T1'][::down2], t_plot[::down2], timeTher['sw']['D1'][::down2],
             t_plot[::down2], timeTher['sw']['C1'][::down2], t_plot[::down2], Ta * np.ones(np.size(t_plot[::down2])))
    ...
    # Temperature
    plt.subplot(2, 2, 4)
    plt.plot(t_plot[::down2], timeTher['sw']['T2'][::down2], t_plot[::down2], timeTher['sw']['D2'][::down2], t_plot[::down2],
             timeTher['sw']['C2'][::down2], t_plot[::down2], Ta * np.ones(np.size(t_plot[::down2])))
    plt.ylabel("$\Theta(t)$ (°C)")
    ...
    # Current
    plt.subplot(4, 1, 1)
    plt.plot(t_plot[::down2], timeDc['i_c'][::down2])
    plt.ylabel("$i(t)$ (A)")
    ...
    # Voltage
    plt.subplot(4, 1, 2)
    plt.plot(t_plot[::down2], timeDc['v_dc'][::down2])
    plt.ylabel("$v(t)$ (V)")
    ...
    # Losses
    plt.subplot(4, 1, 3)
    plt.plot(t_plot[::down2], timeLoss['cap']['C1']['p_L'][::down2])
    plt.ylabel("$p(t)$ (W)")
    ...
    # Temperature
    plt.subplot(4, 1, 4)
    plt.plot(t_plot[::down2], timeTher['cap']['C1'][::down2])
    plt.ylabel("$\Theta(t)$ (°C)")
