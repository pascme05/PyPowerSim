...
def plotResults(time, setupTopo):
    ...
    # Calculation
    ###################################################################################################################
    print('|          |                       OUTPUT                     |                     CURRENT AND VOLTAGE                   |            AVERAGE LOSSES             |                THERMAL                |   Eta   |')
    print('| item ID  | P (W)  | Q (VA) | PF (p.u) | I_ph (A) | V_ph (V) |  I_MAX  |  I_AVG  |  I_RMS  |  V_MAX  |  V_AVG  |  V_RMS  |  P_T_s  |  P_T_c  |  P_D_s  |  P_D_c  | T_T_MAX | T_T_AVG | T_D_MAX | T_D_AVG |    -    |')
    print('|----------|--------|--------|----------|----------|----------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|')
    for i in range(0, len(id)+1):
        if i == len(id):
            print('| %-8s |   --   |   --   |    --    |    --    |    --    |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |                 %5.2f                 |                 %5.1f                 |  %5.2f  |' % (
                lab[i],                                  I_ALL[i,0],I_ALL[i,1],I_ALL[i,2],V_ALL[i,0],V_ALL[i,1],V_ALL[i,2],P_ALL[i,0]*4,T_ALL[i,0],E_ALL[i,0]*100))
            print('|----------|--------|--------|----------|----------|----------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|')
        else:
            print('| %-8s |   --   |   --   |    --    |    --    |    --    |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.2f  |  %5.2f  |  %5.2f  |  %5.2f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.2f  |' % (
                lab[i],                                  I_ALL[i,0],I_ALL[i,1],I_ALL[i,2],V_ALL[i,0],V_ALL[i,1],V_ALL[i,2],P_ALL[i,0],P_ALL[i,1],P_ALL[i,2],P_ALL[i,3],T_ALL[i,0],T_ALL[i,1],T_ALL[i,2],T_ALL[i,3],E_ALL[i,0]*100))
            print('|----------|--------|--------|----------|----------|----------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|')
    print('|----------|--------|--------|----------|----------|----------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|')
    print('|  Total   |  %5.0f |  %5.0f |  %5.2f   |  %5.1f   |  %5.1f   |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.1f  |  %5.2f  |' % (
        P, Q, PF, Iph, Vph, I_CON[0], I_CON[1], I_CON[2], V_CON[0], V_CON[1], V_CON[2], P_CON[0], P_CON[1], P_CON[2], P_CON[3], T_CON[0], T_CON[1], T_CON[2], T_CON[3], E_CON*100))
