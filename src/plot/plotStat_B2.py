...
def plotStat_B2(time, freq, setupPara, setupData, setupTopo, setupExp):
    ...
    # Temperature
    plt.subplot(5, 2, 9)
    plt.plot(t, timeTher['sw']['T1'], t, timeTher['sw']['D1'], t, timeTher['sw']['C1'], t, Ta * np.ones(np.size(t)))
    ...
    # Temperature
    plt.subplot(5, 2, 10)
    plt.plot(t, timeTher['sw']['T2'], t, timeTher['sw']['D2'], t, timeTher['sw']['C2'], t, Ta * np.ones(np.size(t)))
    plt.ylabel("$\Theta(t)$ (°C)")
